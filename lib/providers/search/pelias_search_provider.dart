...
class PeliasSearchProvider implements SearchProvider {
  PeliasSearchProvider({http.Client? client})
      : _client = client ?? http.Client(),
        _ownsClient = client == null;

  static const _baseUrl = 'https://api.geocode.earth/v1';

  final http.Client _client;
  final bool _ownsClient;

  @override
  SearchProviderType get type => SearchProviderType.pelias;
  ...
  SearchResult _parseFeature(dynamic feature) {
    ...
    return SearchResult(
      ...
      address: properties['label'] as String?,
      placeId: properties['gid'] as String?,
    );
  }
